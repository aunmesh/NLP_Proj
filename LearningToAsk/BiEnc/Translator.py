...
def Translator(source_batch_indices, batch_size):
    ...
    decoded_indices = Variable(torch.ones((batch_size, 1))).cuda()
    ...
    for step in range(1, max_output_size):
        ...
        decoded_indices = torch.cat((decoded_indices, next_token_indices), 1)
...
if __name__ == '__main__':
    ...
    src_batch_indices, target_questions_sorted = generate_batch(batch_size, src_data, target_questions)
